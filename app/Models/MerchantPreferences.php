...
class MerchantPreferences extends Model
{
    protected $table    = "merchant_preferences";
      protected $fillable = [
        "merchant_id",
        'api_key', 'secret_key', 'site_token', 'monnify_api_key','monnify_secret_key', 'monnify_contract_code',
        ...
        'education_jamb_api_url', 'education_check_result_api_url', 'education_jamb_verify_api_url','education_purchase_api_url',
