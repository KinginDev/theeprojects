...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Buy Airtime page | Eproject </title>
                                ...
                                <form class="custom-validation" action="transactionview.html">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select p-12" id="validationCustom03"  required>
                                            ...
                                            <option class="d-flex"> MTN </option>
                                            <option class="d-flex"> Airtel</option>
                                            <option class="d-flex"> Glo </option>
                                            <option class="d-flex"> 9Mobile</option>
                                        </select>

                                    </div>
                                    <div class="mb-3">
                                        <label>Phone number</label>
                                        <input type="text" class="form-control p-12"  required placeholder="Recipient Phone number"/>
                                    </div>
                                    ...
                                    <div>
                                        <input type="email" class="form-control p-12"
                                                parsley-type="email" placeholder="Email"/>
                                    </div>
                                </div>
