                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Insurance page</h4>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card moni-card br-2">
                                <div class="d-flex justify-content-between">
                                    <div class="h3">INSURANCE TOPUP PERCENTAGE</div>
                ...
                <div class="container main-tags">
                    <div class="row">
                        <div class="col-12">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="card moni-card br-2">
                                    <div class="h3">INSURANCE TRANSACTIONS</div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered mb-0 align-middle table-hover table-nowrap"
                                            ...
                                            <tbody>
                                                <?php $i = 1; ?>
                                                @foreach ($insurance_transaction as $transaction)
                                                    <tr>
                                                        <td>
