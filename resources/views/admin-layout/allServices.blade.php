...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Betting page | Eproject </title>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="#"><i class="ri-user-line align-middle me-1"></i> Account Setting</a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Betting</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Booking</a></li>
                                            <li class="breadcrumb-item active">Betting page</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="container main-tags">
                            ...
                            <div class="col-md-8 col-sm-12">
                                <form class="custom-validation" action="transactionview.html">

                                    <div class="mb-3">
                                        <label for="validationCustom03" class="form-label">Select Provider</label>
                                        <select class="form-select p-12" id="validationCustom03"  required>
                                            <option selected disabled value="">Choose Provider</option>
                                            <option class="d-flex"> Sporty bet</option>
                                            <option class="d-flex"> Bet 9ja</option>
                                            <option class="d-flex"> Ilot</option>
                                            <option class="d-flex"> Bet King</option>
                                        </select>

                                    </div>
                                    <div class="mb-3">
                                        <label>Phone number or User ID</label>
                                        <input type="text" class="form-control p-12"  required placeholder="Recipient Phone number or User ID"/>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <input type="number" class="form-control p-12" required
                                                    parsley-type="amount" placeholder="Amount to Recharge"/>
                                        </div>
                                    </div>
