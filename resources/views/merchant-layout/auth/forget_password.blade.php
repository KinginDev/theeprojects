        ...
        <div class="container-fluid p-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="text-center font-size-18 text-bold"><b>Forget Password</b></h4>

                    <div class="p-3">
                        <p>Forgotten your password? Enter your email address below, and we'll email instructions for setting a new one.</p>
                        <form action="{{ route('merchant.forget.password') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group mb-3 text-center row mt-3 pt-1">
                                <div class="col-12">
                                    <button class="btn btn-org w-100 waves-effect waves-light" type="submit">Proceed</button>
                                </div>
                            </div>
                        </form>
                    </div>
