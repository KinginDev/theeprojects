                        ...
                        <form action="{{ route('merchant.login.submit') }}" method="post">
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input @error('checkbox') is-invalid @enderror" id="remember"
                                            name="checkbox" {{ old('checkbox') ? 'checked' : '' }}>
                            ...
                            <div class="form-group mb-0 row mt-2">
                                ...
                                <div class="col-sm-5 mt-3">
                                    <a href="{{ route('merchant.register') }}" class="text-muted"><i
