                    ...
                    <div class="p-3">
                        ...
                        'slug' => Helper::merchant()->slug,
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control @error('fname') is-invalid @enderror" type="text" required="" placeholder="Full Name"
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control @error('username') is-invalid @enderror" type="text" required="" placeholder="Username"
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control @error('password_confirmation') is-invalid @enderror" type="password" required=""
                                        placeholder="Confirm password" id="pass" name="password_confirmation">
